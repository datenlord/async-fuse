use crate::utils::better_as::{extending_cast, TruncatingCast, WrappingCast};
...
impl StMode {
    ...
    #[must_use]
    #[inline]
    pub const fn new(ty: FileType, mode: FileMode) -> Self {
        let ty_u32 = extending_cast::u8_to_u32(ty.as_raw());
